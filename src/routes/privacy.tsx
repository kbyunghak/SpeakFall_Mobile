      ...
      <div className="mx-auto max-w-3xl px-6 py-12 md:py-16">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc space-y-2 pl-5 text-slate-300 leading-relaxed">
            <li>
              <span className="font-semibold text-white">음성(마이크) 데이터:</span>{" "}
              게임 플레이 중 단어 발음을 인식하기 위해 실시간으로 사용됩니다. 음성
              데이터는 기기 내에서만 처리되며, 녹음 파일이나 텍스트로 서버에
              전송되지 않습니다.
            </li>
            <li>
              <span className="font-semibold text-white">기기 저장소:</span>{" "}
              게임 진행도, 코인, 획득한 스킨 등을 기기 내부(localStorage)에
              저장합니다. 이 데이터는 사용자의 기기에만 남아 있으며 개발자가
              접근할 수 없습니다.
            </li>
            <li>
              <span className="font-semibold text-white">기기 식별자 및 광고 ID:</span>{" "}
              수집하지 않습니다.
            </li>
            <li>
              <span className="font-semibold text-white">계정 정보:</span>{" "}
              별도의 회원가입이나 로그인이 없어 이메일, 이름, 생년월일 등을
              수집하지 않습니다.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-slate-300 leading-relaxed">
            음성 데이터는 실시간 처리 후 즉시 폐기됩니다. 게임 진행도 등은
            기기 내부에 저장되며, 앱을 삭제하면 함께 삭제됩니다. 별도의 서버에
            개인정보를 보관하지 않습니다.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-slate-300 leading-relaxed">
            본 앱은 사용자의 개인정보를 외부에 제공하거나 판매하지 않습니다.
            향후 분석 도구나 광고 SDK를 추가할 경우, 본 방침을 개정하고 사전에
            안내하겠습니다.
          </p>
        </section>

        <section className="mb-10">
          <h2 className="mb-3 text-xl font-bold text-sky-300">
            5. 아동 개인정보 보호 (COPPA)
          </h2>
          <p className="text-slate-300 leading-relaxed">
            본 앱은 어린이를 포함한 모든 연령이 이용할 수 있도록 설계되었습니다.
            13세 미만 아동의 개인정보를 의도적으로 수집하지 않으며, 음성 인식
            데이터도 기기 내에서만 처리됩니다. COPPA 및 관련 법규를 준수합니다.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-slate-300 leading-relaxed">
            본 개인정보처리방침은 법률 변경 또는 앱 기능 변경에 따라 수정될 수
            있습니다. 중요한 변경 사항이 있을 경우 앱 내 공지 또는 웹사이트를
            통해 안내하겠습니다.
          </p>
        </section>

        <p className="text-sm text-slate-500">최종 개정일: 2026년 8월 7일</p>
      </div>
    </main>
  );
}
